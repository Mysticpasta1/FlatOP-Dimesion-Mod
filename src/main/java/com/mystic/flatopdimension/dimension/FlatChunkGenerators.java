...
public class FlatChunkGenerators extends ChunkGenerator<GenerationSettings> {

    public FlatChunkGenerators(IWorld world, BiomeProvider biomeProvider, GenerationSettings settings) {
    ...
    public void generateSurface(IChunk chunk) {
        ...
        if (FlatConfig.CONFIG.grass_enable.get()) {
            for (x1 = 0; x1 < 16; x1++) {
